export const responsiblesMockData = [
   { key: 'user', label: 'Kullanıcı Modül' },
   { key: 'report', label: 'Rapor Modül' },
   { key: 'stock', label: 'Stock Modül' },
   { key: 'project', label: 'Proje Modül' },
   { key: 'finance', label: 'Maliye Modül' },
