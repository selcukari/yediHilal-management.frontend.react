...
export default [
  ...
  route("safe", "routes/safe.tsx"), route("branches", "routes/branch.tsx"), route("settings-duty", "routes/settings/duty.tsx"), route("settings-meetingType", "routes/settings/meetingType.tsx")
