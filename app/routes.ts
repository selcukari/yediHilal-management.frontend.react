...
export default [
  ...
  route("privacyPolicy", "routes/privacyPolicy.tsx"), route("report-head", "routes/reports/branchReports/headReport.tsx"), route("report-officer", "routes/reports/branchReports/officerReport.tsx"),
