...
import { useBranchReportForHeadService } from '../../../services/branchReportForHeadService';
...
export default function HeadReport() {
  ...
  const fetchBranch = async () => {
     ...
     try {
      ...
      const getBranchReportForHeads = await service.getBranchReportForHeads();
 ...
 // useMemo hook'u ile sütunları önbelleğe alıyoruz
  ...
  const reportTitle = (): string => {
    return "Temsilcilik Başkan Görevli Rapor";
  };
      ...
      <Container size="xl">
        ...
        <Stack gap="lg">
          ...
          <Group justify="space-between" align="center">
            <div>
              <Title order={2}>Temsilcilik Başkan Görevli Rapor Sayfası</Title>
