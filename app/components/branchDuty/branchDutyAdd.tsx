...
export type BranchDutyAddDialogControllerRef = {
  open: () => void;
  close: () => void;
};
...
const BranchDutyAdd = forwardRef<BranchDutyAddDialogControllerRef, UserAddProps>(({onSaveSuccess}, ref) => {
  ...
  const handleSubmit = async (values: FormValues) => {
    ...
    const result = await service.addBranchDuty({
      ...values,
