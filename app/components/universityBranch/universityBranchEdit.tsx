...
const BranchEdit = forwardRef<UniversityBranchEditDialogControllerRef, UniversityBranchAddProps>(({onSaveSuccess}, ref) => {
      ...
      <form onSubmit={form.onSubmit(handleSubmit)}>
        <Stack gap="md">
          <Grid>
            <Grid.Col span={6}>
              <TextInput
                label="Üniversite Adı" placeholder="Üniversite adı giriniz" required
